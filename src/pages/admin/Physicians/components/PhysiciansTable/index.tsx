...
const columns: GridColDef<Physician>[] = [
  ...
  },
  {
    ...
    filterOperators: specializationFilterOperators,
  ...
  },
  {
    ...
    renderCell: ({ row }) => (
      <Tooltip title="Editar">
        <IconButton component={RouterLink} href={`/admin/physicians/${row.id}/edit`}>
...
export const PhysicianTable: FC<Props> = ({ physician }) => {
  return (
    <DataTable
      initialState={{
        columns: {
